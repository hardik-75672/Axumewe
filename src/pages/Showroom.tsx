  ...
  const simulations = [
    {
      ...
      description:
        "Design and manage climate-resilient cities with this comprehensive urban planning simulation. Test different strategies for adaptation, mitigation, and community resilience.",
      features: [
      ...
      useCases: [
        {
          ...
          description: "Urban planning departments",
        },
        {
          icon: GraduationCap,
          label: "Universities",
          description: "Urban studies programs",
        },
    ...
    },
    {
      ...
      description:
        "Explore regenerative business models and test sustainable startup strategies in this interactive business simulation environment.",
      features: [
      ...
      useCases: [
        ...
        },
        {
          ...
          description: "Entrepreneurship courses",
        },
        {
          icon: Building,
          label: "Incubators",
          description: "Startup acceleration",
        },
      ],
      image:
    ...
    },
    {
      ...
      description:
        "A culturally-informed crisis communication platform that combines traditional African communication methods with modern technology.",
      features: [
      ...
      useCases: [
        ...
        },
        {
          icon: Users,
          label: "Communities",
          description: "Local response teams",
        },
    ...
    },
    {
      ...
      description:
        "Harness collective wisdom and scenario planning to explore multiple possible futures and develop robust strategies for uncertainty.",
      features: [
      ...
      <section className="py-16 bg-gradient-to-br from-secondary-50 to-accent-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            >
              Experience our flagship simulations and MVP prototypes designed to
              help organizations, communities, and individuals navigate complex
              challenges through interactive learning.
            </motion.p>
          </motion.div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <div>
              ...
              <h2 className="text-4xl font-african font-bold text-neutral-900 mb-6">
              ...
              <div className="grid grid-cols-3 gap-6 mb-8">
                {Object.entries(simulations[activeDemo].stats).map(
                  ([key, value]) => (
