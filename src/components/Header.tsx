        ...
        <div className="flex justify-between items-center py-4">
          ...
          >
            <Link to="/" className="flex items-center space-x-2">
              ...
              <span
                className={`text-xl font-african font-bold transition-colors duration-300 ${
                  isScrolled || !isHomePage ? "text-tribal-gold" : "text-white"
                }`}
              >
                AxumWe
              </span>
              ...
              <motion.div key={item.name} whileHover={{ y: -2 }}>
                ...
                >
                  ...
                  {location.pathname === item.path && (
                    <motion.div
                      layoutId="activeTab"
                      className={`absolute -bottom-1 left-0 right-0 h-0.5 rounded-african ${
                        isScrolled || !isHomePage
                          ? "bg-tribal-gold"
                          : "bg-tribal-gold"
                      }`}
