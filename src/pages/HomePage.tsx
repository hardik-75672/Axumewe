      ...
      >
        ...
        <div className="absolute inset-0 overflow-hidden">
          ...
          <motion.div
            ...
            animate="animate"
            className="absolute mt-20 left-10 w-32 h-32 border-2 border-tribal-gold/30 rounded-full"
          />
          <motion.div
            variants={floatingVariants}
            animate="animate"
        ...
        {/* Content */}
        <div className="relative top-18 z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
          <motion.div
          ...
          >
            ...
            <div>
              <motion.h1
                ...
                className="text-5xl md:text-7xl lg:text-8xl font-african font-bold mb-8 leading-tight"
              >
                <span className="text-white">Evolving the</span>
                <br />
                <motion.span
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            >
              From AI-augmented foresight tools to regenerative business models,
              our solutions bridge speculative design with practical
              implementation for post-regenerative futures.
            </motion.p>
          </motion.div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            >
              ...
              <span className="text-tribal-gold"> Worlwide</span>
            </motion.h2>
          </motion.div>
      ...
      <section className="py-24 bg-gradient-to-r from-tribal-earth via-tribal-copper to-tribal-kente relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            >
              Join organizations worldwide using our tools to create
              regenerative solutions that bridge ancient wisdom with
              cutting-edge innovation for planetary transformation.
            </motion.p>
