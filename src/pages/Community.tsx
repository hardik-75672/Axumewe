  ...
  const memberships = [
    {
      ...
      description:
        "Join our most exclusive community of senior practitioners, thought leaders, and change agents.",
      features: [
    ...
    },
    {
      ...
      description:
        "Connect with fellow practitioners implementing transition design in their communities and organizations.",
      features: [
    ...
    },
    {
      ...
      description:
        "Participate in intimate storytelling circles that explore possible futures and share wisdom.",
      features: [
  ...
  const events = [
    {
      ...
      description:
        "Our flagship event bringing together change agents from across Africa and beyond.",
      image:
    ...
    },
    {
      ...
      description:
        "Deep-dive workshops on building climate resilience in communities and organizations.",
      image:
    ...
    },
    {
      ...
      type: "Weekly Series",
      description:
        "Intimate conversations with African innovators, entrepreneurs, and thought leaders.",
      image:
  ...
  const benefits = [
    {
      ...
      description:
        "Learn faster through peer collaboration and expert guidance",
    },
    {
      icon: Users,
      ...
      <section className="py-16 bg-gradient-to-br from-secondary-50 to-accent-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            >
              Connect with a global community of change agents, practitioners,
              and visionaries working to create regenerative futures. Learn
              together, share wisdom, and amplify your impact.
            </motion.p>
          </motion.div>
        </div>
      </section>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <motion.h2
              variants={itemVariants}
              className="text-4xl font-african font-bold text-neutral-900 mb-8"
            >
              Choose Your
            ...
            <motion.p
              ...
              className="text-xl text-neutral-600 max-w-3xl mx-auto leading-relaxed font-serif"
            >
              Each membership tier offers unique benefits designed to support
              your journey as a change agent and transition designer.
            </motion.p>
          </motion.div>
              ...
              >
                ...
                {membership.badge && (
                  <div className="absolute -top-4 left-1/2 transform -translate-x-1/2">
                    <span
                      className={`bg-gradient-to-r ${membership.color} text-white px-4 py-2 rounded-full text-sm font-medium shadow-lg`}
                    >
                      {membership.badge}
                    </span>
                  </div>
                ...
                <div className="text-center mb-8">
                  ...
                  <div className="text-sm text-neutral-500">Cancel anytime</div>
                </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-neutral-600 max-w-3xl mx-auto leading-relaxed font-serif">
              Join us for workshops, festivals, and conversations that inspire
              action and build connections across our global community.
            </p>
          </motion.div>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <p className="text-xl text-white/90 mb-8 font-serif">
              Become part of a global movement of change agents working to
              create regenerative futures for all.
            </p>
