...
const Footer = () => {
  ...
  const services = [
    { name: "Sentient Business Design", path: "/services" },
    { name: "AI-Augmented Foresight", path: "/services" },
    { name: "Policy Simulation", path: "/consulting" },
    { name: "MVP-as-a-Service", path: "/services" },
    { name: "Licensing Programs", path: "/licensing" },
  ];

  const resources = [
    { name: "Sentient Business Playbook", path: "/marketplace" },
    { name: "Research Papers", path: "/marketplace" },
    { name: "Free Downloads", path: "/marketplace" },
    { name: "Future Seeds Newsletter", path: "/contact" },
      ...
      <div className="border-b border-neutral-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className="grid lg:grid-cols-2 gap-8 items-center">
            <div>
              <h3 className="text-3xl font-african font-bold mb-4">
          ...
          <div className="lg:col-span-2">
            ...
            >
              <Link to="/" className="flex items-center space-x-2 mb-6">
                ...
                <span className="text-2xl font-african font-bold text-primary-400">
                  AxumWe
                </span>
              </Link>
                ...
                {quickLinks.map((link) => (
                  <li key={link.name}>
                    <Link to={link.path}>
                      <motion.span
                        whileHover={{ x: 5 }}
                        className="text-neutral-300 hover:text-tribal-gold transition-colors duration-200 cursor-pointer font-african"
                      >
                        {link.name}
                      </motion.span>
                    </Link>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center text-sm text-neutral-400">
            <p className="font-african">
              © 2024 AxumWe. All rights reserved. Ubuntu • Evolving Afrika's
              future with ancestral wisdom.
            </p>
