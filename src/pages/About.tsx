        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            >
              ...
              <span className="text-tribal-gold"> Futures Studio</span>
            </motion.h1>
            ...
            >
              ...
              into the building blocks of a thriving, intelligent,
              post-regenerative civilization.
            </motion.p>
          </motion.div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <motion.div
              ...
              className="text-center lg:text-left"
            >
              <div className="inline-flex items-center justify-center w-16 h-16 bg-secondary-100 text-secondary-500 rounded-full mb-6">
                <Target size={32} />
              </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-neutral-600 max-w-3xl mx-auto leading-relaxed font-african">
              Four core domains where we pioneer Africa's transition from
              sustainable to regenerative to sentient futures.
            </p>
          </motion.div>
