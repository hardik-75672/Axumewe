      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
        ...
        >
          ...
          <motion.h1
            ...
            className="text-5xl md:text-7xl lg:text-8xl font-african font-bold text-white mb-8 leading-tight"
          >
            We Design
            <br />
          ...
          >
            Blending African heritage with modern innovation to create
            extraordinary digital experiences that inspire and connect cultures
            worldwide.
          </motion.p>
