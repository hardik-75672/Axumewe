  ...
  const upcomingEvents = [
    {
      ...
      description:
        "Our flagship annual event bringing together 500+ change agents, innovators, and visionaries from across Africa and beyond.",
      image:
    ...
    },
    {
      ...
      location: "Virtual",
      description:
        "Deep-dive workshop on integrating climate resilience into urban planning processes using our City Builder simulation.",
      image:
    ...
    },
    {
      ...
      location: "Virtual",
      description:
        "Intimate conversation with successful African entrepreneurs implementing regenerative business practices.",
      image:
    ...
    },
    {
      ...
      description:
        "Comprehensive masterclass on systems thinking tools and methodologies for complex problem solving.",
      image:
  ...
  const pastEvents = [
    {
      ...
      description:
        "Three-day summit exploring the future of transition design in African contexts.",
      image:
    ...
    },
    {
      ...
      location: "Virtual",
      description:
        "Monthly webinar series on building community resilience through participatory design.",
      image:
    ...
    <div className="min-h-screen pt-20">
      ...
      <section className="py-16 bg-gradient-to-br from-secondary-50 to-primary-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            >
              Join our global community at workshops, festivals, and
              conversations that inspire action and build connections across
              ...
              <div>
                ...
                <div className="grid grid-cols-2 gap-6 mb-8 text-white/80">
                  ...
                  <div className="flex items-center space-x-2">
                    <MapPin size={16} />
                    <span>
                      {filteredEvents.find((e) => e.featured)?.location}
                    </span>
                  </div>
                  <div className="flex items-center space-x-2">
                    <Users size={16} />
                    <span>
                      {filteredEvents.find((e) => e.featured)?.capacity}
                    </span>
                  </div>
                  <div className="flex items-center space-x-2">
                    <Zap size={16} />
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            {filteredEvents
              .filter((e) => !e.featured || viewMode === "past")
              .map((event) => (
                <motion.div
                  key={event.id}
                  layout
      ...
      <section className="py-16 bg-gradient-to-r from-secondary-500 to-primary-500">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <p className="text-xl text-white/90 mb-8 font-serif">
              Never miss an opportunity to learn, connect, and grow with our
              global community.
            </p>
