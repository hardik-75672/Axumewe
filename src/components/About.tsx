  ...
  const values = [
    {
      ...
      description:
        "Every project is infused with our love for design and African culture",
    },
    {
      icon: Globe,
      title: "Global Perspective",
      description:
        "Connecting local heritage with international design standards",
    },
    {
      icon: Award,
    ...
    },
    {
      ...
      description:
        "Building bridges between communities through thoughtful design",
    },
  ];
        ...
        >
          ...
          <div>
            ...
            <motion.h2
              ...
              className="text-4xl md:text-5xl font-african font-bold text-neutral-900 mb-8 leading-tight"
            >
            ...
            >
              Founded on the belief that design should tell stories and connect
              cultures, Axumwe is more than a design studio—we're cultural
              ambassadors in the digital realm. Our name, inspired by the
              ancient Kingdom of Axum, reflects our commitment to building
              lasting legacies through exceptional design.
            </motion.p>
            ...
            >
              We specialize in creating digital experiences that honor African
              aesthetics while embracing global design trends, ensuring every
              project resonates with both local authenticity and international
              appeal.
            </motion.p>
