...
const Marketplace = () => {
  ...
  const products = [
    {
      ...
      description:
        "Interactive simulation game for designing climate-resilient urban environments",
    ...
    },
    {
      ...
      description:
        "52 strategic thinking cards for navigating complex transitions",
    ...
    },
    {
      ...
      description:
        "Complete guide to regenerative design thinking and implementation",
    ...
    },
    {
      ...
      description:
        "Beautiful poster series celebrating African innovation and futures",
    ...
    },
    {
      ...
      description:
        "Visual framework for mapping complex systems and relationships",
    ...
    },
    {
      ...
      description:
        "Comprehensive toolkit for building community resilience and adaptation",
  ...
  return (
    <div className="min-h-screen pt-20 font-african">
      {/* Hero Section */}
      <section className="py-16 bg-gradient-to-br from-primary-50 to-secondary-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            >
              Discover our collection of games, simulations, frameworks, and
              learning materials designed to help you navigate complex
              challenges and design regenerative futures.
            </motion.p>
          </motion.div>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <p className="text-xl text-white/90 mb-8 font-serif">
              Be the first to know when we release new games, frameworks, and
              learning materials.
            </p>
