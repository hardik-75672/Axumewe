  ...
  const services = [
    {
      ...
      description:
        "Bespoke serious games and simulations tailored to your specific challenges and learning objectives.",
      features: [
    ...
    },
    {
      ...
      description:
        "Navigate uncertainty with scenario planning, trend analysis, and strategic futures thinking.",
      features: [
    ...
    },
    {
      ...
      description:
        "Expert facilitation of transition games and workshops to drive organizational and community change.",
      features: [
    ...
    },
    {
      ...
      description:
        "Co-design innovative policy solutions through participatory design and systems thinking approaches.",
      features: [
        "Stakeholder mapping",
    ...
    },
    {
      ...
      description:
        "Reshape organizational and community narratives to enable transformative change.",
      features: [
    ...
    },
    {
      ...
      description:
        "Train your team to become certified facilitators of transition design tools and methodologies.",
      features: [
  ...
  const process = [
    {
      ...
      description:
        "We start with a deep dive into your challenges, goals, and context to understand how we can best support your transformation journey.",
    },
    {
      step: "02",
      title: "Proposal & Planning",
      description:
        "Based on our discovery, we craft a tailored proposal with clear deliverables, timelines, and success metrics.",
    },
    {
      step: "03",
      title: "Co-Design Process",
      description:
        "We work collaboratively with your team to design and develop solutions that fit your unique needs and constraints.",
    },
    {
      step: "04",
      title: "Implementation",
      description:
        "Together, we implement the solution with ongoing support, iteration, and refinement based on real-world feedback.",
    },
    {
      step: "05",
      title: "Impact & Evolution",
      description:
        "We measure impact, capture learnings, and support the evolution of your solution for sustained transformation.",
    },
  ];
      ...
      <section className="py-16 bg-gradient-to-br from-accent-50 to-primary-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            >
              Partner with us to design custom solutions, facilitate
              transformative workshops, and build internal capacity for
              navigating complex challenges and creating regenerative futures.
            </motion.p>
          </motion.div>
        </div>
      </section>
              ...
              >
                ...
                <div className="bg-neutral-50 rounded-lg p-4 mb-6">
                  ...
                  <p className="text-sm text-neutral-600 mb-2">
                    <strong>{service.caseStudy.client}:</strong>{" "}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-neutral-600 max-w-3xl mx-auto leading-relaxed font-serif">
              We believe in co-creation and partnership. Here's how we work
              together to design and implement transformative solutions.
            </p>
          </motion.div>
      ...
      <section className="py-16 bg-gradient-to-r from-accent-500 to-primary-500">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h2 className="text-3xl md:text-4xl font-african font-bold text-white mb-6">
              Ready to Start Your Transformation?
            </h2>
            <p className="text-xl text-white/90 mb-8 font-serif">
              Book a discovery call to explore how our consulting services can
              help your organization navigate complexity and create regenerative
              impact.
            </p>
